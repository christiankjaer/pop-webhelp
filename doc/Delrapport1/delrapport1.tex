...
\caption{Klassediagram for opgave 2.6}
\end{figure}
\begin{figure}[ht!]
\includegraphics[scale=0.8]{diagrammer/E2_7}
\caption{Klassediagram for opgave 2.7}
\end{figure}
\begin{figure}[ht!]
\includegraphics[scale=0.8]{diagrammer/E2_9}
\caption{Klassediagram for opgave 2.9}
\end{figure}
\begin{figure}[ht!]
\includegraphics[scale=0.8]{diagrammer/E2_10}
\caption{Klassediagram for opgave 2.10}
\end{figure}
\FloatBarrier
\subsection{OOSE 5.3}
\subsection{OOSE 7.1}
\begin{figure}[ht!]
\includegraphics[scale=0.7]{diagrammer/E7_1}
\caption{Klassediagram for opgave 7.1}
\FloatBarrier
\end{figure}
